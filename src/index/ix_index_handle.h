...
class IxNodeHandle {
   ...
   public:
    ...
    std::pair<page_id_t, int> internal_lookup(const char *key,bool flag);

    bool leaf_lookup(const char *key, Rid **value);
    std::pair<bool, int> leaf_lookup(const char *key, Rid **value,bool flag);

    int insert(const char *key, const Rid &value);
    std::pair<int, int> insert(const char *key, const Rid &value,bool flag);
    ...
    std::pair<int, int> remove(const char *key,bool flag);
