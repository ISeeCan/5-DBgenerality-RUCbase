...
void *client_handler(void *sock_fd) {
    ...
    while (true) {
        ...
        // Lab 3 need to remove transaction part -comment the line in 121
        // Lab 4 need to restart transaction  -uncomment the line below
        ...
        // 如果是单条语句，需要按照一个完整的事务来执行，所以执行完当前语句后，自动提交事务   //Lab4时需要取消183-186行的注释，若正在做之前的lab，请确保注释没有取消
